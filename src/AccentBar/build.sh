...
stage_app="$stage_dir/TinkLink.app"
...
<key>CFBundleName</key><string>TinkLink</string>
<key>CFBundleDisplayName</key><string>TinkLink</string>
<key>CFBundleExecutable</key><string>TinkLink</string>
...
<key>NSHumanReadableCopyright</key><string>TinkLink</string>
</dict></plist>
PLIST
...
/usr/bin/xcrun swiftc "${swift_flags[@]}" -parse-as-library \
    ...
    "$source_dir/ChromeAutomation.swift" -o "$stage_app/Contents/MacOS/TinkLink"
